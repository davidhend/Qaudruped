 ...
 */
#define X_COXA      82  // MM between front and back legs /2
#define Y_COXA      42  // MM between front/back legs /2

/* Legs */
#define L_COXA      35  // MM distance from coxa servo to femur servo
#define L_FEMUR     80 // MM distance from femur servo to tibia servo
